...
export const GitlabSettings = {
  ...
  integrationSettings: {
    ...
    toolbar: {
      ...
      isSaveDisabled: property('disabled', SELECTORS.INTEGRATION_SETTINGS_SAVE_BUTTON),
      isDeleteDisabled: property('disabled', SELECTORS.INTEGRATION_SETTINGS_DELETE_BUTTON),
