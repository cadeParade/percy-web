...
export default Route.extend({
  ...
  //   controller.set('build', resolvedModel.build);
  ...
  //     orderedSnapshots: this._initializeSnapshotOrdering(),
  //   });
  // },
  ...
  _initializeSnapshotOrdering() {
    ...
    let controller = this.controllerFor('organization.project.builds.build2');
  ...
  //     const build = this._getBuild();
  //     this.send('updateIsHidingBuildContainer', false);
  //     this.transitionTo('organization.project.builds.build2.index', build.get('id'));
  //   },
